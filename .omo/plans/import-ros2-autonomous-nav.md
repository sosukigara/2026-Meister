# import-ros2-autonomous-nav - Work Plan
...
- Evidence: <attemptDir>/task-<N>-import-ros2-autonomous-nav.<ext> (attemptDir = currentAttemptDir from 'omo ulw-loop status --json', .omo/evidence/ulw/<session>/<goalId>/a<attempt>; outside ulw-loop use .omo/evidence/)
...
- [ ] 1. <title>
  ...
  QA scenarios (name the exact tool + invocation): happy + failure, Evidence <attemptDir>/task-1-import-ros2-autonomous-nav.<ext>
